    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O_MR1) {
                sqLiteDatabase = this.openOrCreateDatabase("LeagueData.db", MODE_PRIVATE, null);
            }
            ...
            if(tablesCursor.moveToFirst()) {
                ...
                String message = "These are no tables in database";
                builder.setMessage(message);

                builder.setNeutralButton("Create new", (((dialog, which) -> {
                        dialog.dismiss();
                    startActivity( new Intent(Display_Results.this, AddLeagueData.class) );
                })));
            }

            builder.setNegativeButton("Cancel", ((dialog, which) ->  {
                dialog.cancel();
                startActivity( new Intent(Display_Results.this, MainActivity.class) );
            }));
